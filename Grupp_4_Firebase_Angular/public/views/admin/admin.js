        ...
        angular.module('app')
                .controller('AdminCtrl', function (currentAuth, $scope, $firebaseObject, $firebaseArray) {
                        ...
                        userRef.child('groups/school').once('value').then(function (data) {
                                ...
                                var newsRef = firebase.database().ref().child('news/' + mySchool + '/YAPP-APP');
                                ...
                                $scope.createNews = function (news, title, type) {
                                        newsRef.child(type + '/' + today + '_' + time());
                                        ref.set({
                                                content: news,
                                                title: title
                                        });
                                ...
                                //skapa veckofeedback
                                var feedbackRef = firebase.database().ref().child('feedback/' + mySchool + '/YAPP-APP');
                                var weekFeedbackFormRef = feedbackRef.child('weekly/' + date.getFullYear() + "_" + + date.getWeek() + '/form');
